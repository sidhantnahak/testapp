        ...
        <>
            <div className='mb-10 mx-auto max-w-[600px]'>
                <form onSubmit={onsubmitHandler}>
                    <input type="text" className='border-2 border-black rounded-lg h-[38px] w-[300px] py-1 px-2' placeholder='Search...' onChange={((e) => setsearchValue(e.target.value))} />
                    <input onClick={(e)=>mysetBooks(books)} type="button" value="Reset" className='py-1 px-2 border-2 border-black rounded-lg mx-2 hover:bg-[black] hover:text-white cursor-pointer shadow-lg' />
                    <input type="submit" value="Search" className='py-1 px-2 border-2 border-black rounded-lg hover:bg-[black] hover:text-white cursor-pointer shadow-lg' />
                </form>
